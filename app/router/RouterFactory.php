...
class RouterFactory
{
	...
	public static function createRouter()
	{
		...
		$router[] = new Route('/intence/tisk-full/[<date>]', 'Intention:exportFull');
		$router[] = new Route('/intence/vykaz/[<date>]', 'Intention:statement');
		$router[] = new Route('/intence/pokladna/', 'Intention:cache');
		...
		$router[] = new Route('<presenter>[/<action>][/<id>]', 'Intention:default');
		return $router;
	}
